...
def init_mouse():
    ...
    #if len(_string) > 0:
    #    os.system("xinput --set-prop 'Logitech USB-PS/2 Optical Mouse' 'Device Enabled' 0") # disable X-forwarding of events
    ...
    if len(_string) == 0:
        ...
        #if len(_string) > 0:
        #    os.system("xinput --set-prop 'Logitech USB Optical Mouse' 'Device Enabled' 0") # disable X-forwarding of events
    ...
    if len(_string) == 0:
        ...
        #if len(_string) > 0:
        #    os.system("xinput --set-prop 'Dell Dell USB Optical Mouse' 'Device Enabled' 0") # disable X-forwarding of events
